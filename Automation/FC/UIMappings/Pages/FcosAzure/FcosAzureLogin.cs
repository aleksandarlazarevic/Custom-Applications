...
{
    public class FcosAzureLogin : BasePage
    {
        ...
        #region Methods
        public FcosAzureLogin EnterCredentials(string email, string password)
        {
            try
            {
        ...
        public FcosAzureLogin EnterMicrosoftCredentials(string email, string password)
        {
        ...
        public FcosAzureLogin ClickOnSignIn()
        {
            SignInButton.ClickWrapper("SignIn");
            return this;
        }

        public FcosAzureLogin ClickOnMicrosoftSignIn()
        {
            MicrosoftSignInButton.ClickWrapper("SignIn");
            return this;
        }

        public FcosAzureLogin ClickStaySignedInYesButton()
        {
            StaySignedInYesButton.ClickWrapper("Stay Signed In Yes Button");
            return this;
        }

        public FcosAzureLogin WaitForPageReady()
        {
            By email = this.GetElementBy(this.GetType(), "EmailAddress");

            WaitForPageToBeReady<FcosAzureLogin>(email, "Email", 10);
