...
using DeviceIOManager.Objects.Disk;
using DeviceIOManager.Objects.Enums;
using DeviceIOManager.Objects.FileSystem;
using DeviceIOManager.Objects.MountManager;
using DeviceIOManager.Objects.Usn;
using DeviceIOManager.Wrapper;
using Microsoft.Win32.SafeHandles;
using FileAttributes = System.IO.FileAttributes;


namespace PhysicalDeviceManager
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ExampleDiskIO(@"\\.\PhysicalDrive6");
            ExampleDiskIO(@"\\.\PhysicalDrive7");
            ...
            const string driveToBeEjected = @"\\.\CdRom0";
            // Open and close CD Rom tray
            ExampleCdRomIO(@"\\.\PhysicalDrive7");
        ...
        private static void ExampleDiskIO(string drive)
        {
        ...
        private static void ExampleCdRomIO(string drive)
        {
